...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    ImGuiWindowFlags window_flags = ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_Popup | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedoptions | ImGuiWindowFlags_NoMove;
...
bool ImGui::DragBehaviorT(ImGuiDataType data_type, TYPE* v, float v_speed, const TYPE v_min, const TYPE v_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    // Inputs accumulates into g.DragCurrentAccum, which is flushed into the current value as soon as it makes a difference with our precision options
...
bool ImGui::BeginMainMenuBar()
{
    ...
    // FIXME: Consider removing support for safe area down the line... it's messy. Nowadays consoles have support for TV calibration in OS options.
    g.NextWindowData.MenuBarOffsetMinVal = ImVec2(g.Style.DisplaySafeAreaPadding.x, ImMax(g.Style.DisplaySafeAreaPadding.y - g.Style.FramePadding.y, 0.0f));
    ImGuiWindowFlags window_flags = ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedoptions | ImGuiWindowFlags_MenuBar;
    ...
    // Temporarily disable _NoSavedoptions, in the off-chance that tables or child windows submitted within the menu-bar may want to use options. (#8356)
    g.CurrentWindow->Flags &= ~ImGuiWindowFlags_NoSavedoptions;
    BeginMenuBar();
    return is_open;
}
...
void ImGui::EndMainMenuBar()
{
    ...
    EndMenuBar();
    g.CurrentWindow->Flags |= ImGuiWindowFlags_NoSavedoptions; // Restore _NoSavedoptions (#8356)
...
bool ImGui::BeginMenuEx(const char* label, const char* icon, bool enabled)
{
    ...
    ImGuiWindowFlags window_flags = ImGuiWindowFlags_ChildMenu | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoSavedoptions | ImGuiWindowFlags_NoNavFocus;
...
bool ImGui::TabBarProcessReorder(ImGuiTabBar* tab_bar)
{
    ...
    *tab2 = item_tmp;
    ...
    if (tab_bar->Flags & ImGuiTabBarFlags_Saveoptions)
        MarkInioptionsDirty();
    return true;
}
